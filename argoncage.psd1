#
# Module manifest for module 'argoncage'
#
...
@{
    ...
    GUID                  = 'af141095-ba60-4aea-b17c-9aa1187246cd'
    ...
    NestedModules         = @(
        "./libs/net6.0/Konscious.Security.Cryptography.Argon2.dll"
    )
